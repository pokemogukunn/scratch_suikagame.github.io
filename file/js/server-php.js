;(function(window, document, undefined){
    ...
    var BANNER_LIST_FOR_ANDROID = [
        {
            img: ASSET_DIR + 'eigo_memories.gif',
            url: 'https://ad.xdomain.ne.jp/rd.php?aid=xdomain_eigo_memories_a'
        }
    ];
    var BANNER_LIST_FOR_OTHER = [
        {
            img: ASSET_DIR + 'eigo_memories.gif',
            url: 'https://ad.xdomain.ne.jp/rd.php?aid=xdomain_eigo_memories_i'
        }
    ];
    /* --------------------------------------------------------------------- */
